...
/**
 * Class representing a cell which the Maze is built.
 */
public class Cell 
{
	/**
	 ...
	 * 
	 * @see {@link hu.unideb.inf.maven.CellType CellType}
	 */
	private CellType type;
	
	/**
	 * Represents that whether the cell contains food.
	 */
	 ...
	 *
	 * @param row the row of the cell in the maze
	 * @param column the column of the cell in the maze
	 ...
	 *
	 * @param containsFood whether the cell contains food
	 */
	...
	/**
	 * Returns the (x, y) coordinates of a cell located on the specified row and column in the maze.
	 * 
	 * @param row the row of a cell in the maze
	 * @param col the column of a cell in the maze
	 * @return the (x, y) coordinates of the cell located on the specified row and column in the maze
	 */
